...
@MenuItem("Terrain/Export Texture New") 
...
var bytes = texture.EncodeToPNG(); 
    var path = AssetDatabase.GetAssetPath (Selection.activeObject);
 			File.WriteAllBytes(Application.dataPath.Substring(0,Application.dataPath.Length-6)+path.Replace(".asset","_mask.png"), bytes); 
